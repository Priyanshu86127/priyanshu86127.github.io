...
// Swap titles every 2 seconds (2000 milliseconds)
setInterval(() => {
    // Update the index (cycle back to 0 when reaching the end)
    jobIndex = (jobIndex + 1) % jobTitles.length;
    // Change the text content to the current title
    jobTitleElement.textContent = jobTitles[jobIndex];
}, 3000);
